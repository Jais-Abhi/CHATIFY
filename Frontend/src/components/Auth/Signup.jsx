    ...
    <div className='w-full h-screen bg-slate-300 flex justify-center items-center' >
      ...
      <div className='flex flex-col justify-center items-center '>
        <form  className='flex flex-col justify-center items-center w-full' onSubmit={(e)=>submitHandler(e)} >
          ...
          <input className='mt-10 px-4 py-2 w-4/5 border-[rgb(170,58,201)] border-2 rounded-[20px]' type="text" name="username" placeholder='username' required onChange={(e)=>setusername(e.target.value)} value={username} />
